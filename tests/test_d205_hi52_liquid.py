...
the Cagan note), the frozen 2-way verdict (TRADEABLE-EDGE / YINE-TRADEABLE-DEGIL, with the
...
# ---------------------------------------------------------------------------
# gate-4 -- within-liquid sub-tier consistency + lower-half SAMPLE SIZE (Cagan note)
# ---------------------------------------------------------------------------

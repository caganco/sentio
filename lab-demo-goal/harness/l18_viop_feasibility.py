...
NO network, NO real-data edge claim (real run pending the basis-panel build + the maintainer go-ahead).
    ...
    results = {
        ...
        "summary": {
            ...
            "interpretation": (
                ...
                "daily SPOT XU030 level) -- no network fetch, just a local build + the maintainer go-ahead."),
        },
        "verdict": {

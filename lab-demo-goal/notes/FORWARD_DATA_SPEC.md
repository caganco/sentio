...
Bu bir SPEC'tir, kod-calistirma DEGIL. Ag/auth gerektiren her cekim CAGAN-ONAYI ile yapilir
...
- **OFFLINE-COVERAGE PROBE (read-only, 2026-06-04)**: `data/cache/` SADECE 4 proof-of-concept
  ...
  scraper de GEREKMEZ -- mevcut `kap_historical_fetcher` semasi hazir; tek-gereken Cagan-onayli
...
Cagan-onayi -> veri-cekim (mevcut-modul-genislet) -> snapshot (gitignored, force-add) -> Stage-0

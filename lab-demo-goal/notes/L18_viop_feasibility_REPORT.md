...
yeni-edge YOK. Direktif ACIKCA VIOP istedi. L11-deseni: aday VIOP faktorlerini on-kaydet, BIST-VIOP
...
- **Gercek-run icin EKSIK = INSA-EDILMIS baz-paneli**: front-month XU030 vadeli settlement, gunluk SPOT
  XU030 endeks-seviyesine hizalanmis. Bu bir LOKAL-BUILD'tir (network DEGIL) + Cagan-go-ahead.
...
Direktifin VIOP avenusu kristalize edildi. Stage-0 "VIOP-yok" premise'i YANLIS cikti (ham EOD arsivi lokal,
...
gunluk SPOT XU030) + Cagan-go-ahead bekler -- ag-fetch DEGIL, lokal-build. N<=1 (scaffold). L18 ARSIVLENDI.

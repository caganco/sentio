...
- Verdict-kurali: keep-bar gecerse TRADEABLE-EDGE (deploy-aday -> Cagan); yoksa NOT-TRADEABLE
...
network-fetch'in Cagan-onayina KAPILI -- otonom-faz herhangi bir cekimden ONCE kasitli durur.

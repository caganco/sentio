...
DEGIL, network YOK, yeni-edge YOK. Spec ACIKCA NLP istedi. L16'dan FARKLI: sinyal duyarlilik-polaritesi
...
- Verdict-kurali: gecerse o-tip TRADEABLE-EDGE (deploy-aday -> the maintainer); yoksa NLP-TYPE-NOT-TRADEABLE.
...
- **Veri-gap sayisal**: snapshot tip-cesitliligi var ama gecmis-derinlik/gun-damgasi YOK -> backtest
  IMKANSIZ. Gercek-test tarihsel KAP tam-metin arsivi + NLP-pipeline (the maintainer-onayli) ister.
...
Specin NLP avenusu L11-forward-scaffold formuna kristalize edildi, L16-polaritesinden ayri: HANGI
ifsa-tipi drift ongoruyor, cok-test-kontrollu. Test donmus + pipeline-dogru; gercek gun-damgali ifsa-metin
fetch'inden (the maintainer-kapili) tek-adim uzakta. Sentetik PASS yalniz pipeline + look-ahead-guvenligi + Bonferroni

...
**DEC-039:** Bu belge OLCER/HARITALAR. Trend-test tasarimi + reusable secimi O+Cagan karari.
...
Bu tablo OLCER/HARITALAR. "Reusable" isareti "kullanilabilir" demektir, "kullanilacak" anlamina gelmez — trend-test Stage 0 tasarimi O+Cagan karari.
...
| Dosya | Durum |
|-------|-------|
| `docs/ARCHITECTURE.md` | v2.0 — guncel (30 Mayis 2026, Cagan tarafindan yazildi) |

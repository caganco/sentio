...
**Approved By:** Cagan  
**Execution Owner:** Cagan (manual — irreversible operation, human must confirm each step)  
**Implementation Owner:** Cagan (not delegatable to Builder — git history rewrite requires human sign-off)

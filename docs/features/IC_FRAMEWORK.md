...
**Sorumlu direktifler:** D-139, D-140, D-141(bekliyor), D-142(bekliyor)
...
| Yasak | Neden |
|-------|-------|
| `IC_INVESTABLE_MONTHS_MIN`'i artırma | 6 ay Cagan kararı (DEC-024) |
...
| Weight'leri manuel güncelleme | DEC-023: WeightCalibrator → Orchestrator onay → ayrı direktif |

...
**Sorumlu direktifler:** D-149a/b/c/d/e
...
**Faz 2 için Architect direktifini yazmadan önce:** tarihsel KAP veri kaynağını netleştir (KAP API ~2020'den mi, yoksa daha kısa mı?).

...
| [RR-038](research/RR-038-MODERN-BIST.md) | Modern BIST (2019–2026) davranış rejimi kanıt-haritası — kesitsel REVERSAL/contrarian hâlâ baskın (Bildik-Gülay geçerli, momentuma dönmedi); endeks-seviyesi yabancı net alımı öncü (hisse-seviyesi DEĞİL); pandemi sonrası sürü davranışı güçlendi; saf kesitsel momentum DESTEKLENMİYOR — önerilen tasarım: zaman-serisi trend filtresi + akış teyidi + aşırı-uzamış kaçınma + sıkı maliyet eşiği | 31 May 2026 | RR-001/002/020; smart money kanalı | ⏳ Uygulanmadı — sistem tasarımı için kanıt haritası; saf momentum stratejisi reddi, trend-filtre + akış-teyit yönü |
| [RR-039](research/RR-039-RULEBASED-TA.md) | Kural-tabanlı TA: görsel sezgiyi makine-hesaplanabilir kurala çevirme (swing/long) — S/R=ekstremum kümeleme; kırılım+retest=kapanış-üstü+hacim+tolerans bandı; konsolidasyon=BB bandwidth/ATR/NR7; çok-yükselmiş=MA%sapma+RSI+ardışık gün; araçlar pandas-ta/scipy.find_peaks/vectorbt; TA koşullu işliyor (Park-Irwin 2007) ama maliyet edge'i siler; en büyük risk look-ahead/survivorship/data-snooping | 31 May 2026 | RR-038; per-trade expectancy harness | ⏳ Uygulanmadı — kural-tabanlı setup kütüphanesi + vectorbt tarama yol haritası; maliyet-sonrası + random-benchmark zorunlu |

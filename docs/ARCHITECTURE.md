...
**Statü:** Yön kararı (O+Cagan). Detay-SPEC ayrı (SPEC_YOL2).
...
- Saf-endeks vs aday-daraltma+insan-seçim: HANGİSİ daha iyi → TEST (Cagan "testle doğrula")
...
Mimari sözleşme. Her direktif saygı gösterir:

...
> Bu dosya, BIST OS'un yeni mimarisinin **tek kaynak gerçeğidir**. Tüm SPEC'ler, specler ve refactor kararları buna referans verir. Eski 5-katman linear-additive composite mimarisi terk edilmiştir (OS_STATE'de tarihsel referans olarak korunur).
...
> Bu sorular Architect SPEC'ten ÖNCE kapatıldı (NRR-002 + NRR-003 + the maintainer kararı + Orchestrator + D-176 ampirik). Architect bunları varsayım değil, KARAR olarak alır.

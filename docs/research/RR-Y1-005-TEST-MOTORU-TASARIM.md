...
### 4.3 Rejim — manuel-girdi, motor-tespiti-değil (Çağan-düzeltmesi, S#14)
...
**Dürüst-kalıntı (masada):** rejime-özgü doğrulanmış edge'in canlı-değeri, manuel-rejim-çağrının doğruluğuna koşulludur. Bu Çağan-üstlenimi; motor-iddiası-değil.

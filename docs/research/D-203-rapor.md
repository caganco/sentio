...
> Verdict bir overlay ADAYI'dir en fazla; deployment karari ayri (Orchestrator+Cagan).

## 1. Cozulen celiski

Iki kesif labi (her ikisi de junction'li, commit'siz; builder1-homed) AYNI uc adayda
ZIT sonuca varmisti:
...
### Pencere farki (Cagan duzeltme-2 -- aciklikla belirtiliyor)
...
### Rejim-split (Cagan duzeltme-1 -- ikisi de raporlaniyor)
- **PRIMER 2022-01-01** (Gate-3'u KARARLASTIRIR): takvim-yili siniri, direktif dili
...
2. **Sadece olcum, deployment degil.** GERCEK-EDGE verdict'i bile bir overlay ADAYI'dir;
   canliya alma ayri bir O+Cagan karari.

...
**Tarih:** 1 Haziran 2026 | **Branch:** feat/k2-factor-tilt-backtest | **Karar sahibi:** Orchestrator+Cagan (DEC-039)
...
- **Ince in/out (R4, Cagan bilincli-kabul):** ~6-7 donem/dilim -> genis CI. Veri-siniri (faktor fundamental-gerektirir, temiz pre-2018 veri yok) -- plan-kusuru degil. Tek-dilim over-interpret edilmedi; in/out kontrasti yine de bilgilendirici.
...
4. Tum testler (D-191 + sonrakiler) bitince O+Cagan tam-sistemi kurar (Secenek-2: once-tum-testler).

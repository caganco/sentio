...
**Hedef Kitle:** Builder (implementation-ready); Cagan (karar-verici); Public release recruiter testi
...
- **Custom implementation** (önerilen): ~200 satır, 1-2 günde; Cagan budget + audit isolation.
...
Cagan'ın 6 aylık backtest'i ≈ 0.5 yıl << 2.21 yıl → **N=12 deneme için teorik minimum altında**. 5-yıl önerimiz (Bölüm 7) bu hesabı rahatlıkla karşılar.
...
## 9. Library Karşılaştırma — Cagan $0 Budget Analizi
...
**Cagan $0 hedefi için sonuç: Hudson & Thames mlfinlab kullanılmaz.**
...
### 16.3 Cagan'ın Bu Rapor Sonrası Öğrenecekleri
...
4. **Bailey, D.H., Borwein, J.M., López de Prado, M. & Zhu, Q.J. (2014)** "Pseudo-Mathematics and Financial Charlatanism", *Notices of the AMS* 61(5):458-471. MinBTL teoremi (Thm 3.1) — Cagan 6-aylık backtest'inin yetersizliğinin matematiksel kanıtı.
...
2. **Computational cost**: CPCV 15 patika × 6 katman × 5 yıl ≈ 7-8 dakika single-thread, 2 dakika 4-core. Cagan'ın laptop spec'ine bağlı.
...
10. **Cagan broker bilgisi belirsizliği**: RR-015 Tier A/B/C paralel hesap. Backtest 3 tier ayrı senaryo üretmeli; nihai karar broker netleştiğinde verilir.
...
## Önerilen Karar Eşikleri (Cagan için)

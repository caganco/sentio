...
**BIST OS'un %15'i nerede oturuyor?** Family office üstünde, retail hedge fund altında, Bridgewater Pure Alpha II profiline yakın. **the maintainer (21 yaşında) profiline %15 hard agresif**; soft floor (%5/%10) eklenmesi psikolojik DD hassasiyetini azaltır.
...
| **Önerilen (the maintainer)** | **%15** | Bridgewater Pure Alpha I |
...
## 9. the maintainer Portföy Analizi
...
### 9.5 the maintainer Kelly Önerisi
...
**the maintainer için: half-Kelly (α=0.5) veya quarter-Kelly (α=0.25).** İlk 6 ay quarter-Kelly, performans tutarlı ise half-Kelly. Full Kelly **asla** retail uzun horizon için.
...
**Sonuç:** Aktif vol-aware sizing + DD soft gate uzun horizon retail için **zorunlu**. the maintainer profili için özellikle önemli.
...
- ✅ EWMA vol estimation.
- ✅ the maintainer v3 simulated DD ≤ %12, Calmar ≥ 1.0, UI ≤ 6.0.
...
4. **Long-only retail için tam Kelly tehlikeli.** the maintainer profili → half/quarter-Kelly.
...
4. the maintainer portföyü için "kavramsal v3" pozisyon önerisinin "mevcut v2"den ne kadar saptığını yan-yana karşılaştır.

...
**Tarih:** 25 Mayıs 2026
**Yazar:** Claude Code (Builder)
**Status:** ⏳ Karar bekliyor (Yol A/B/C — Orchestrator + Cagan, DEC-039 pattern)
**Bağlı:** NRR-002 ([SPEC_PIVOT_ARCHITECTURE_1.md:133](../SPECS/SPEC_PIVOT_ARCHITECTURE_1.md#L133)), D-170/172 (MKK VYK), D-175 (yfinance fallback), D-178 (Faz 0 sonuçları), RR-020 (BIST veri atlası), RR-021 (EVDS3), RR-031 (KAP Next.js dead path)
...
[`SPEC_PIVOT_ARCHITECTURE_1.md:133`](../SPECS/SPEC_PIVOT_ARCHITECTURE_1.md#L133)'ten doğrudan alıntı:
...
## §6 Öneri (KARAR DEĞİL — Orchestrator + Cagan, DEC-039 pattern)
...
Karar Orchestrator + Cagan'da (DEC-039 paterni).

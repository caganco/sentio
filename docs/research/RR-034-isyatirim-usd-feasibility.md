...
**Tarih:** 30 Mayıs 2026
**Yazar:** Claude Code (Builder) — canlı probe (throwaway)
**Status:** ⚠️ Kontrol tamamlandı — USD-bazlı "Yol A" tarihsel IC için YEŞİL DEĞİL (snapshot-only). Karar Orchestrator+Cagan (DEC-039).

...
**Bağlam:** DEC-045 (Yol-1 pivot-v2, altyapı-önce). Bu doküman RR-Y1-005'in *neyi-niçin* kısmıdır; *nasıl-kodlanacağı* Faz-2 build-direktifindedir.
...
**Dürüst-kalıntı (masada):** rejime-özgü edge'in canlı-değeri, manuel-rejim-çağrının doğruluğuna koşulludur. Çağan-üstlenimi; motor-iddiası-değil.
...
| 4 | Embargo (h) | Builder-ölçer / Stage-0 | **h := sinyal-construction-window (h≥1), sinyale-özgü** (tek-sayı-değil) |

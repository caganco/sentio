...
**Tarih:** 3 Haziran 2026. **Builder/Cagan.**
...
> meşru-yeni-test. **Bu rapor SADECE veri-fizibilitesi; ölçüm sonraki-adım (O+Cagan).**
...
## Veri-edinim PLANI (Cagan ne-açmalı) — boşa-veri-toplama-YOK (D-200 dersi)
...
2. **MKYO haftalık-NAV (TEK kritik-eksik):** KAP haftalık net-aktif-değer / birim-pay-değeri bildirimleri.
   ...
   - Cagan-aksiyonu: KAP-arşiv-erişimi (veya MKK_VYK CA-benzeri NAV-bildirim endpoint'i) + **açık
...
1. **Cagan-karar:** KAP haftalık-NAV küçük-probu (1-2 MKYO, 1 yıl) açılsın-mı → parse + lag + haftalık-
...
2. Prob-OLUMLU-ise: D-206-mimarisini MKYO-haftalık-iskonto-MR'a-uyarla (Stage-0-dondur, time-series-gate,
   look-ahead-safe-haftalık-lag, LOHO, carry-trap, D-204-maliyet) — **AYRI ölçüm-adımı (O+Cagan), bu-rapor-DEĞİL.**

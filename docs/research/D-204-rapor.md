...
> karari ayri (Orchestrator+Cagan).
...
- **Kadans VIEW'lari** (common pencere; SECIM DEGIL, hepsi raporlanir):
  ...
  **cherry-picking = optimizasyon** olur ki D-204'te YASAK. Bu uc kadans ayni olcumun uc
  ...
  monoton-olmayan bir gozlem olarak hayatta-kalmasi gelecek bir direktif icin ipucu olabilir
...
> deployment ayri O+Cagan karari.

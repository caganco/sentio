...
**Tarih:** 2026-05-26  
**Yazar:** Builder (Claude Sonnet 4.6) — Cagan ile beyin fırtınası oturumu  
...
*Not: Bu değişiklikler CLAUDE.md gereği direktif + etkilenen dosyalar listesiyle Orchestrator onayına sunulmalı.*
...
2. Bölüm 5.1'deki hızlı kazanımları direktif olarak sıralayın (ayrı D-XXX her biri için)
...
5. "LLM KAP metin okuma" protatipini küçük ölçekte test edecek bir araştırma direktifi açın (RR → CB → direktif pipeline'ı)

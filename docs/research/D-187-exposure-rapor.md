...
prim KANITLANMADI. Aktif-zamanlama elendi. → premise/tasarım O+Cagan (DEC-039).
...
Bu program ÖLÇTÜ + frozen DEC-045 verdict üretti. Karar O+Cagan. Builder önerisi:
...
- **Sonraki adım seçenekleri (O+Cagan):** (a) statik çok-varlık tahsis (equity+altın+TLREF) reel

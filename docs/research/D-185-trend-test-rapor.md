...
**Survivorship:** survivors-only -> expectancy UST-SINIR. (Cagan cercevelemesi: random'i
maliyet-sonrasi gecemese kesin elenir; gectigi icin "kesin red" YOK -- ama UST-SINIR oldugu
icin "kesin kabul" de YOK.)

**KARAR (DEC-039, O+Cagan):** Edge sinyali umut verici ve look-ahead-temiz, AMA (i) risk/DD
...
## 8. Survivorship UST-SINIR cercevesi (Cagan kosulu)
...
D-186 duzeltmelerinin yapilip yapilmayacagi, premise'in korunup korunmayacagi O+Cagan karari.

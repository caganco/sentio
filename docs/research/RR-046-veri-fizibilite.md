...
takvim public/ucuz. **AŞAMA-2-onayı O+Cagan'a kalır (aşağıdaki PAUSE).**
...
> = saatler-mertebesi, sınırlı/cache'lenebilir AMA hızlı-prob-DEĞİL. Bütçeli-koşu (O+Cagan-onay).
...
## Sonraki adım — AŞAMA-2 (PAUSE, O+Cagan-onay-bekler)

> **DURDU. Aşağısı ÖNERİ; çekim YAPILMADI.** directive: "olumluysa AŞAMA-2-çekim (O+Cagan-onay)".

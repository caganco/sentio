...
Amac (kullanici speci: *"yapisal fix i bizi yanltmayacak sekilde yap"*): tek-degisken
...
- Change-form (delta r_ex_ante) tartismasi bu fix'ten SONRAYA ertelendi (kullanici speci).

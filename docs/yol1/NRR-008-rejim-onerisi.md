...
> hesaplanmadi). Amac: Cagan+O'nun TEK-degisken + esik onaylamasi -> sonra Stage-0 DONAR ->
...
| **Esik (gerekce-temelli)** | TCMB-hedef-bandi / yapisal-seviye gerekcesiyle YoY ~ **%25-35** araligi. Kesin-sayi bu-asamada DONMAZ -- Cagan+O-onayinda donar. Sonuc-temelli-secim YASAK. |
...
**Aday-B** ornek-uzunlugundan ELENIR (durustce flag'lendi). **Aday-C** Cagan FX-stres-cercevesi
...
> Adaylar-arasinda edge'e-gore-secim = p-hacking = YASAK. Cagan+O TEK-degisken + esik onaylayinca
...
## 5. ONAYLANDI (Cagan+O, 2026-06-03) -- Aday-A, YON-tanimi

Cagan+O **Aday-A'yi YON-tanimiyla** onayladi (seviye-esigi DEGIL):

...
## Mevcut Sistem Durumu (Phase 1-3 Tamamlandı ✅)
...
### Layer 1: Market Data ✅ (Mevcut)
- Yahoo Finance → OHLCV, volume
- SQLite storage

### Layer 2: Macro Intelligence ❌ (Phase 3)
- Crude oil, USD/TRY, Gold, S&P500, VIX
- TCMB faiz kararları
- Sektör rotasyon modeli
- Rejim sınıflandırması

### Layer 3: Corporate Intelligence ❌ (Phase 2 — NEXT)
...
### Layer 4: Sentiment & Narrative ❌ (Phase 4)

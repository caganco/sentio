...
Rapor burada: `C:\Users\cagan\bist-trading-system\reports\report_YYYY-MM-DD.html`
...
**Logları kontrol et:**
```powershell
type C:\Users\cagan\bist-trading-system\logs\errors.log
```

**Config güncelle:**
```powershell
notepad C:\Users\cagan\bist-trading-system\config.yaml
```

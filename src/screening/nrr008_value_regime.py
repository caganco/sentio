...
look-ahead-safe trailing-12m YoY-TUFE 6-month DIRECTION rule (Aday-A, APPROVED Cagan+O
...
def nrr008_verdict(
    ...
    mask is fit-free but its EFFICACY is not OOS-proven). Deployment is a separate O+Cagan
    ...
    if g5 and be_ok:
        return {
            ...
            "deploy_note": ("ILK deploy-edilebilir value-temelli Yol-1 cross-sectional aday "
                            ...
                            "ADAY, deploy ayri O+Cagan karari, otomatik-DEGIL"),
            "oos_gap": _OOS_GAP,
        }

...
the Yol-1 lab (and how) is an Orchestrator+Cagan decision. Builder recommends, does not decide.
"""
...
# currently UNTRACKED in this clone -- a separate commit decision (Cagan/Orchestrator).
SURPRISE_METRIC = "real_yoy"

...
the Katman A motor is an Orchestrator+Cagan decision.
...
# Close x Volume). NOTE (D-185 flagged substitution, Cagan-approved): the
...
# ---------------------------------------------------------------------------
# Variant A -- S/R-Flip Retest (Cagan core intuition; tested FIRST)
# ---------------------------------------------------------------------------

...
Two regime splits (Cagan correction-1): PRIMARY 2022-01-01 (calendar-year boundary;
...
Two windows (Cagan correction-2): PRIMARY common 2019-07..2026-04 (degoran+TUFE overlap;
...
# ---------------------------------------------------------------------------
# Regime splits (Cagan correction-1). PRIMARY decides Gate-3; SECONDARY reported for

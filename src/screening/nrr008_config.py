...
only) and APPROVED by Cagan+O on 2026-06-03 in DIRECTION form (Aday-A inflation-direction).
...
# ---------------------------------------------------------------------------
# Regime-direction signal (Aday-A, APPROVED Cagan+O 2026-06-03; DIRECTION-not-LEVEL).
